...
class Point(object):
    ...
    def move_to(self, new_x, new_y):
        self.total_traveled = self.total_traveled + self.get_distance_from(
            Point(new_x, new_y))
        self.x = new_x
        self.y = new_y
    ...
    def get_distance_from(self, second_point):
        distance_x = (second_point.x - self.x)
        distance_y = (second_point.y - self.y)
        return math.sqrt(distance_x ** 2 + distance_y ** 2)

    def get_distance_from_start(self):
        distance_x = (self.x - self.x_start)
        distance_y = (self.y - self.y_start)
        return math.sqrt(distance_x ** 2 + distance_y ** 2)

    def get_distance_traveled(self):
        return self.total_traveled
    ...
    def halfway_to(self, p2):
        distance_x = ((self.x - p2.x) / 2) + p2.x
        distance_y = ((self.y - p2.y) / 2) + p2.y
